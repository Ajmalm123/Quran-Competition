...
<html>
    ...
    <head>
        <title>ASLAM HOLY QUR’AN AWARD - Emailer</title>
            ...
            <style>
                ...
                .admit-card {
                    border: 1px solid #DDDDDD; /* Add stroke here */
                ...
                .candidate-info table {
                    width: 100%;
                    border-collapse: collapse; /* Ensure cells don't have spaces between them */
                }
                .candidate-info td {
                    font-size: 14px;
                    padding: 8px 0;
                ...
                .candidate-info .title {
                    font-weight: bold;
                    padding-right: 10px; /* Adjust spacing between title and value */
                }
    ...
    <body>
        <table align="center" style="width: 100%;">
            ...
            <tr>
                <td style="background-image: url('{{ url('/images/email_head.png') }}'); background-size: cover; background-position: center; height: 140px;">
            ...
            <tr>
                <td style="padding: 0px 80px;">
                    <h5 style="font-size: 14px; margin: 0; line-height: 22px; font-weight: 400; color: #000000;">
                        ...
                        <b><?= $mailData['application']->application_id ?? 'Not Available' ?></b>…ൽ െവച്ച്നടക്കുന്ന േമഖലാ തല മത്സരത്തിലാണ്താങ്കൾ പങ്കെ
                        ്<b><?= $mailData['application']->application_id ?? 'Not Available' ?></b>തി)……ന്രാവിെല 9 മണി മുതൽ ൈവകുന്നേരം 4 മണി വെരയാണ്മത്സരം
    ...
    അനുഗ്രഹിക്കട്ടെ, ആമീൻ. 
            ...
            <tr>
                <td style="padding: 0px 80px;">
                    <h5 style="font-size: 14px; margin: 0; padding-top: 0; padding-bottom: 10px; font-weight: 400; color: #000000;">
                        ...
                        <tr>
                            <td>
                                <table style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td style="height: 60px; background-color: #F4F4F4; padding: 0 32px; display: flex; justify-content: space-between; align-items: center;">
                                            <h1 style="font-size: 16px; margin: 0;">ADMIT CARD</h1>
                                            <img src="{{ url('/images/logo_admitcard.png') }}" alt="Logo" style="width: 160px; height: 28px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 32px; display: flex; align-items: center;">
                                            <div class="candidate-photo" style="width: 98px; height: 126px; background-color: #ddd; margin-right: 32px;">
                                                <img src="candidate-photo.jpg" alt="Candidate Photo" style="width: 100%; height: 100%;">
                                            </div>
                                            <div class="candidate-info">
                                                <table style="width: 100%; border-collapse: collapse;">
                                                    <tr>
                                                        <td style="font-size: 12px; font-weight: regular; color: #000000; padding-right: 10px;">Application ID:</td>
                                                        <td style="font-size: 15px; font-weight: 600; padding-right: 25px; color: #000000;">XXXXXXX</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 12px; font-weight: regular; color: #000000; padding-right: 10px;">Full Name:</td>
                                                        <td style="font-size: 15px; font-weight: 600; color: #000000;">John Doe dasdasd sdas dasd</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 12px; font-weight: regular; color: #000000; padding-right: 10px;">Center Name:</td>
                                                        <td style="font-size: 15px; font-weight: 600; color: #000000;">Center ABC</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size: 12px; font-weight: regular; color: #000000; padding-right: 10px;">Date:</td>
                                                        <td style="font-size: 15px; font-weight: 600; color: #000000;">YYYY-MM-DD</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </td>
